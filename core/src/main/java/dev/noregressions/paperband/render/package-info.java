 ...
 * <ol>
 *   <li>Create a new Maven module that depends on {@code pagewright-core}.</li>
 ...
 *   <li>Add the new module as a dependency of {@code pagewright-cli} (or any other consumer).</li>
 * </ol>
 *
 ...
 *       only renderer pagewright ships with. Best CSS; first run downloads
